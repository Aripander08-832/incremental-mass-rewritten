const BOSONS = {
    ...
    gain: {
        pos_w() {
            let x = E(1).mul(tmp.bosons.effect.neg_w?tmp.bosons.effect.neg_w[1]:1).mul(tmp.bosons.effect.z_boson?tmp.bosons.effect.z_boson[1]:1).mul(tmp.bosons.effect.graviton?tmp.bosons.effect.graviton[0]:1)
        ...
        neg_w() {
            let x = E(1).mul(tmp.bosons.effect.pos_w?tmp.bosons.effect.pos_w[1]:1).mul(tmp.bosons.effect.z_boson?tmp.bosons.effect.z_boson[1]:1).mul(tmp.bosons.effect.graviton?tmp.bosons.effect.graviton[0]:1)
        ...
        z_boson() {
            let x = E(1).mul(tmp.bosons.effect.graviton?tmp.bosons.effect.graviton[0]:1)
            if (hasTree('ct2')) x = x.mul(treeEff('ct2'))
        ...
        graviton() {
            let x = E(1).mul(tmp.bosons.effect.graviton?tmp.bosons.effect.graviton[0]:1).mul(tmp.fermions.effs[1][1])
            if (hasTree('ct2')) x = x.mul(treeEff('ct2'))
            if (QCs.active()) x = x.pow(tmp.qu.qc_eff[3])
            if (hasPrestige(1,3)) x = x.pow(prestigeEff(1,3))
        ...
        hb() {
            let x = E(1).mul(tmp.fermions.effs[1][1])
            if (hasTree('ct2')) x = x.mul(treeEff('ct2'))
